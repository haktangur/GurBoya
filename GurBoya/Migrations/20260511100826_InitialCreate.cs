        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StokMiktari = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                    KritikStokSeviyesi = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KasaHareketleri_Musteriler_MusteriId",
                        column: x => x.MusteriId,
                        principalTable: "Musteriler",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_KasaHareketleri_Siparisler_SiparisId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IndirimYuzde = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KasaHareketleri_MusteriId",
                table: "KasaHareketleri",
                column: "MusteriId");

            migrationBuilder.CreateIndex(
                name: "IX_KasaHareketleri_SiparisId",
                table: "KasaHareketleri",
                column: "SiparisId");
